...
class Work
{
	...
	public:
		...
		{
			std::cout << "Количество заменяемых частей - " << std::endl;
			std::cout << "Стоимость ремонта каждого станка - " << sum_repair_cost << std:: endl;
			std::cout << "Количество поломок всех станков - " << sum_amount_of_breakages << std::endl;
			std::cout << "Суммарный простой станков - " << sum_breaking_time << " часов" << std::endl;
			std::cout << "Максимальный суммарный простой одного станка - " << std::endl;
		}
};
